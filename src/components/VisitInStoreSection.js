...
const VisitInStoreSection = () => {
  return (
    <section className="w-full bg-gradient-to-br from-white to-gray-50 py-8 md:py-12">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
          {/* Left Section: Image */}
          ...
          <div className="w-full md:w-1/2 p-8 md:p-12 lg:p-16 text-center md:text-left flex flex-col justify-center items-center md:items-start">
            <div className="mb-6">
              <IoLocationOutline className="text-5xl text-green-600 mx-auto md:mx-0 mb-4" />
              <h2 className="text-4xl lg:text-5xl font-extrabold text-gray-900 leading-tight">
                Visit Our Fresh Outlets: <br /> Experience Quality Live!
              </h2>
            </div>
